...
import './checkout.css';
import img from '../../components/assets/OIP-removebg-preview.png';
import img2 from '../../components/assets/11090350.png';
...
const Checkout = () => {
    ...
    const handlePayClick = () => {
        // Show success modal when the pay button is clicked
        setShowModal(true);
    };
            ...
            <div className="checkout">
                ...
                <div className="billing-summary">
                    ...
                    <div className="terms-policy">
                        ...
                        <label htmlFor="terms">Please check to acknowledge our Privacy & Terms Policy</label>
                    </div>
                    <button className="pay-button" onClick={handlePayClick}>Pay $3,439.00</button>
                </div>
            </div>
